...
<%@ page language="java" import="simplestblog.Post"%>
<%@ page language="java" import="p1.ServiceInvoker"%>
...
<div id="home">
    <div class="posts">
        <nav class="art-list">
            <div class="postcontainer1">
                <ul class="art-list-body">
                  ...
                  <%
                      ...
                      int i = 0;
                      while (i < size) {
                        if (listpost.get(i).getStatus().equals("unpublished")) {
                  %>
                  <li class="art-list-item">
                      <div class="art-list-item-title-and-time">
                          <h2 class="art-list-title"><a href="post.jsp?id_post=<% out.print(listpost.get(i).getIdPost()); %>"><% out.print(listpost.get(i).getJudul());%></a></h2>
                          <div class="art-list-time"><% out.print(listpost.get(i).getTanggal()); %></div>
                      </div>
                          <p><% out.print(listpost.get(i).getKonten()); %></p>
                      <p>
                          <a href="editpost.jsp?id_post=<% out.print(listpost.get(i).getIdPost()); %>">Edit</a> | 
                          <a onclick="return confirm('Are you sure to delete this post?')"  href="softdelete.jsp?id_post=<% out.print(listpost.get(i).getIdPost()); %>">Hapus</a> |
                          <a href="publish.jsp?id_post=<% out.print(listpost.get(i).getIdPost()); %>">Kirim</a>
                      </p>
                  </li>
                  <% } i++;  } }
                  catch (Exception e) {
            ...
            <%
                List<simplestblog.Post> listpost2 = new ArrayList<simplestblog.Post>();
                listpost2 = ServiceInvoker.listPost();
                ...
                <ul class="art-list-body">
                    <f:subview id="soft-deleted" rendered="#{Login.isAdmin()}"><li> <a style="font-style: italic; color: black">Deleted Post</a> </li></f:subview>
                  <%
                      int size = listpost.size();
                      int i = 0;
                      while (i < size) {
                        if (listpost.get(i).getStatusDelete().equals("deleted")) {
                  %>
                  <f:subview id="softsoft" rendered="#{Login.isAdmin()}"><li class="art-list-item"></f:subview>
                      <div class="art-list-item-title-and-time">
                          <f:subview id="soft1" rendered="#{Login.isAdmin()}"><h2 class="art-list-title"><a href="post.jsp?id_post=<% out.print(listpost2.get(i).getIdPost()); %>"><% out.print(listpost2.get(i).getJudul());%></a></h2></f:subview>
                          <f:subview id="soft2" rendered="#{Login.isAdmin()}"><div class="art-list-time"><% out.print(listpost2.get(i).getTanggal()); %></div></f:subview>
                      </div>
                          <f:subview id="soft3" rendered="#{Login.isAdmin()}"><p><% out.print(listpost2.get(i).getKonten()); %></p></f:subview>
                      <p>
                      <f:subview id="soft4" rendered="#{Login.isAdmin()}"><a href="restore.jsp?id_post=<% out.print(listpost2.get(i).getIdPost()); %>">Restore</a></f:subview>
                      </p>
                  </li>
                  <% } i++;  } }
                  catch (Exception e) {
