...
<body class="default">
    ...
    <article class="art simple post">
        ...
        <header class="art-header">
            ...
            <f:subview id="header" rendered="#{!Login.isGuest() and !Login.isEditor()}"><h2 class="art-title">Create Post</h2></f:subview>
            </div>
        </header>
        ...
        <div class="art-body-inner">
                ...
                <div id="contact-area">
                    <f:subview id="create-post" rendered="#{!Login.isGuest() and !Login.isEditor()}"><form method="post" enctype="multipart/form-data" action="connect" onSubmit="return postValidation()">
                        ...
                        <label for="Konten">Content:</label><br>
                            ...
                            <f:subview id="button" rendered="#{!Login.isGuest() and !Login.isEditor()}"><input type="submit" name="submit" value="Simpan" class="submit-button"/></f:subview>
                        </form></f:subview>
                </div>
            
                <h:outputLabel rendered="#{Login.isGuest() or Login.isEditor()}" style="text-align:center;">You can not access this page</h:outputLabel>
            </div>
        </div>
    </article>
    </div>
