    ...
    <article class="art simple post">
        ...
        <header class="art-header">
            <div class="art-header-inner">
                <time class="art-time"><% out.print(tanggal); %></time>
                <h2 class="art-title"><% out.print(judul); %></h2>
        ...
        <div class="art-body">
            <div class="art-body-inner">
                ...
                <p><% out.print(konten); %></p>
                
                <hr />
                
                <%
                    List<simplestblog.Comment> listcomment = new ArrayList<simplestblog.Comment>();
                    listcomment = ServiceInvoker.listComment();
                    try {
                ...
                <%
                    int size = listcomment.size();
                      int i = 0;
                      while (i < size) {
                      if (listcomment.get(i).getIdPost().equals(request.getParameter("id_post"))) { %>
                    <li class="art-list-item">
                        <div class="art-list-item-title-and-time">
                            <h2 class="art-list-title"><a href="post.jsp"><% out.print(listcomment.get(i).getNama()); %></a></h2>
                            <div class="art-list-time"><% out.print("2014-12-20 18:00");%>
                            </div>
                        </div>
                            <p><% out.print(listcomment.get(i).getKonten()); } i++; }%></p>
                    </li>  
                </ul>
            </div>
        </div>
